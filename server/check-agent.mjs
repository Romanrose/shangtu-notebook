...
if (timingSummary.trials !== 4 || timingSummary.localAwakening.p50Ms !== 281 || timingSummary.transcriptionResult.count !== 3 || timingSummary.confirmation.count !== 2 || timingSummary.resultAvailableRate !== 3 / 4 || timingSummary.confirmationAvailableRate !== 1 / 2 || timingSummary.editedConfirmationRate !== 1 / 2 || timingSummary.byProviderStatus.length !== 4 || timingSummary.byProviderStatus[0].provider !== "paddleocr" || timingSummary.byProviderStatus[0].confirmation.count !== 1 || timingSummary.byProviderStatus[0].confirmationAvailableRate !== 1 || timingSummary.byProviderStatus[0].editedConfirmationRate !== 0) throw new Error("时延汇总没有区分 provider、本地苏醒、服务结果、确认时延和修改率。");
