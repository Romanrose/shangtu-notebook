...
function Notebook() {
  ...
  return <main className="book-shell">
    ...
    <section className={`paper ink-${inkState}`} aria-label="可书写纸页">
      ...
      {mode === "seek" && !hasInk && !pendingTranscription && annotations.length === 0 && <aside className="first-trace" aria-label="起笔提示"><span>起笔</span><p>写下一个你想追寻的人物。</p><em>试写：苏轼　李白　李清照</em><small>先定人物，再沿着他的时间、地点与作品继续寻迹。</small></aside>}
