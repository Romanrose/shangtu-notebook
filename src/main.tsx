...
async function postJson(path: string, body: unknown) {
  ...
  return response.json() as Promise<{ status: string; transcription?: TranscriptionProposal; providerStatus?: string; provider?: string; outcome?: TraceOutcome }>;
}
...
function Notebook() {
  ...
  const finish = () => {
    ...
    if (mode === "seek" && hasInkRef.current && isTranscriptionExperiment) {
